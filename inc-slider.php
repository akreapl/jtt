<div id="carouselExampleDark" class="carousel carousel-dark slide carousel-fade d-none d-md-block" style="margin-top:70px;">
    <div class="carousel-inner">
        <div class="carousel-item bg-slider active position-relative overflow-hidden" data-bs-interval="10000">
            <img src="<?php echo get_template_directory_uri(); ?>/img/v3/1.svg" class="" alt="...">
            <div class="d-none d-md-block position-absolute" style="width:35%; top:80px; right:15%;">
                <div>
        ...
        <div class="carousel-item bg-slider position-relative overflow-hidden" data-bs-interval="10000">
            <img src="<?php echo get_template_directory_uri(); ?>/img/v3/2.svg" class="" alt="...">
            <div class="d-none d-md-block position-absolute" style="width:35%; top:80px; right:15%;">
                <div>
        ...
        <div class="carousel-item bg-slider position-relative overflow-hidden" data-bs-interval="10000">
            <img src="<?php echo get_template_directory_uri(); ?>/img/v3/3.svg" class="" alt="...">
            <div class="d-none d-md-block position-absolute" style="width:35%; top:80px; right:15%;">
                <div>
        ...
        <div class="carousel-item bg-slider position-relative overflow-hidden" data-bs-interval="10000">
            <img src="<?php echo get_template_directory_uri(); ?>/img/v3/4.svg" class="" alt="...">
            <div class="d-none d-md-block position-absolute" style="width:35%; top:80px; right:15%;">
                <div>
...
<div class="d-block d-md-none" style="margin-top:70px;">
    <div class="d-flex align-content-center align-items-center justify-content-end" style="height:350px; background-image: url(<?php echo get_template_directory_uri(); ?>/img/v3/slider-mobile3.svg); background-size:cover;">
        <!-- <img src="<?php echo get_template_directory_uri(); ?>/img/v3/slider-mobile2.svg" class="" alt="..."> -->
        <h1 class="slider-header ms-5 pb-5 mb-5">Nie podążamy schematem, <span class="text-primary fw-bolder fst-italic">piszemy historię</span></h1>
    </div>
</div>